...
class InformacionVentana extends Component {
    ...
    constructor(props) {
        ...
        this.info_material = [];
        this.info_marcos = [];
        axios.get("https://152.74.52.185:80/api/info_ventanas")
            .then(response => this.getJson(response));
        axios.get("https://152.74.52.185:80/api/info_marcos")
    ...
    getFilteredRadiation(comuna,tipo,mes){
        axios.get("https://152.74.52.185:80/api/radiaciones/"+comuna+"/"+tipo+"/"+mes)
            .then(response => {
