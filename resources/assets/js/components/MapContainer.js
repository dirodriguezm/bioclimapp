  ...
  mapClicked(e){
    ...
    .then(response => {
        this.setState({
          ...
          sunPosition: this.getSunPosition(e.latlng.lat, e.latlng.lng, new Date(2018,6,21,14,0,0,0) ),
          sunTimes: this.getSolarTimes(e.latlng.lat, e.latlng.lng,  new Date(2018,6,21,14,0,0,0) ),
