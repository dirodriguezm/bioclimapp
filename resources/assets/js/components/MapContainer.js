...
export default class MapContainer extends Component {
    ...
    componentWillMount(){
        ...
        axios.get("http://localhost/api/comuna/" + this.state.lat + "/" + this.state.lng)
            .then(response => {
    ...
    mapClicked(e) {
        ...
        axios.get("http://localhost/api/comuna/" + e.latlng.lat + "/" + e.latlng.lng)
            .then(response => {
    ...
    handleLocationFound(e) {
        ...
        axios.get("http://localhost/api/comuna/" + lat + "/" + lng)
            .then(response => {
                    this.setState({
                        lat: lat,
                        lng: lng,
