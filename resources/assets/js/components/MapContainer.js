...
export default class MapContainer extends Component {
    ...
    componentWillMount(){
        ...
        axios.get("http://bioclimatic.inf.udec.cl:8000/comuna/" + this.state.lat + "/" + this.state.lng)
            .then(response => {
    ...
    mapClicked(e) {
        ...
        axios.get("http://bioclimatic.inf.udec.cl:8000/comuna/" + e.latlng.lat + "/" + e.latlng.lng)
            .then(response => {
    ...
    handleLocationFound(e) {
        ...
        axios.get("http://bioclimatic.inf.udec.cl:8000/comuna/" + lat + "/" + lng)
            .then(response => {
                    this.setState({
                        lat: lat,
                        lng: lng,
